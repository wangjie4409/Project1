document.write("<a id=\"StranLink\" href=\"javascript:StranBody()\" title=\"点击以简体中文方式浏览\">简体中文</a>");
var Default_isFT = 0		//默认是否繁体，0-简体，1-繁体
var StranIt_Delay = 50 //翻译延时毫秒（设这个的目的是让网页先流畅的显现出来）

//－－－－－－－代码开始，以下别改－－－－－－－
//转换文本 参数--txt:即将要转换的文本,toFT:0或1 标识即将要转换的文本是否转成繁体,函数内有检测,所有第二参数可选,chgTxt:0或1 是否转换的是导航处文本，所以第三参数可选（待确定）
